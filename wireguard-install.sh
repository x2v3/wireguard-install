...
PostUp = iptables -I FORWARD -o ${SERVER_WG_NIC} -j ACCEPT
...
PostUp = ip6tables -I FORWARD -o ${SERVER_WG_NIC} -j ACCEPT
...
PostDown = iptables -D FORWARD -o ${SERVER_WG_NIC} -j ACCEPT
...
PostDown = ip6tables -D FORWARD -o ${SERVER_WG_NIC} -j ACCEPT
